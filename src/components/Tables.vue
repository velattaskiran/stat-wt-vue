    ...
    <main id="table">
        <div class="relative my-10 grid-center md:place-items-end md:mt-20 md:mx-6">
            ...
            <input type="search" id="default-search"
                class="block py-2 pl-5 w-48 text-sm text-black placeholder-gray-500 rounded-md border border-gray-600 focus:ring-blue-500 focus:border-blue-500 focus:outline-none md:w-96"
